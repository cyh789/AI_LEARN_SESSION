...
const styleText =
  options.style === "pepe"
    ? "Pepe meme inspired, playful cartoon aesthetic, clean line art, friendly pastel palette."
    : options.style;
...
- ${styleText}
- Simple, readable layout with large title and generous spacing
